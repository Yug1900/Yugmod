...
package net.mcreator.yugmod.world.biome;
...
import net.mcreator.yugmod.entity.YugEntity;
import net.mcreator.yugmod.YugmodModElements;

@YugmodModElements.ModElement.Tag
public class YugbiomespawnBiome extends YugmodModElements.ModElement {
	public static Biome biome;
	public YugbiomespawnBiome(YugmodModElements instance) {
		super(instance, 6);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(YugEntity.entity, 10, 1, 3));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.2f).temperature(0.5f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("yugmod:yugbiomespawn"));
			}
		}
	}
	@Override
