...
public class Yuginolandbiome1Biome extends YugmodModElements.ModElement {
	public static Biome biome;
	public Yuginolandbiome1Biome(YugmodModElements instance) {
		super(instance, 2);
			...
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.STONE.getDefaultState(),
								YuginoBlock.block.getDefaultState(), YuginoBlock.block.getDefaultState())));
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(YugEntity.entity, 20, 4, 20));
				...
				event.getRegistry().register(biome.setRegistryName("yugmod:yuginolandbiome_1"));
			}
		}
	}
	@Override
